...
\setuphead
  ...
  [alternative=text,
    style=bold,
    before={{\bf 习题 }},
    numbercommand={\headnumber[chapter].\determineheadnumber[subsection]\currentheadnumber\gobbleoneargument}]

\definestartstop
  [Exercise]
  [before={\startframedtext[width=broad]\exercise{}}, after={\stopframedtext}]
